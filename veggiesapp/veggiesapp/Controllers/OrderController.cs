...
namespace veggiesapp.Controllers
{
    public class OrderController : Controller
    {
        ...
        public ActionResult Unconfirm()
        {
            ...
            list = (from orm in model.ordermasters.Where(m => m.OrderStatus == 0)
        ...
        public ActionResult confirm()
        {
            ...
            list = (from orm in model.ordermasters.Where(m => m.OrderStatus == 1)
                    join cust in model.customers on orm.uid equals cust.id
                    select new OrdermasterCustomerjoin
                    {
                        objordmaster = orm,
        ...
        public ActionResult packing()
        {
            ...
            list = (from orm in model.ordermasters.Where(m => m.OrderStatus == 2)
                    join cust in model.customers on orm.uid equals cust.id
                    select new OrdermasterCustomerjoin
                    {
                        objordmaster = orm,
        ...
        public ActionResult outfordelivery()
        {
            ...
            list = (from orm in model.ordermasters.Where(m => m.OrderStatus == 3)
                    join cust in model.customers on orm.uid equals cust.id
                    select new OrdermasterCustomerjoin
                    {
                        objordmaster = orm,
        ...
        public ActionResult delivered()
        {
            ...
            list = (from orm in model.ordermasters.Where(m => m.OrderStatus == 4)
                    join cust in model.customers on orm.uid equals cust.id
                    select new OrdermasterCustomerjoin
                    {
                        objordmaster = orm,
        ...
        public ActionResult returnorder()
        {
            ...
            list = (from orm in model.ordermasters.Where(m => m.OrderStatus == 5)
                    join cust in model.customers on orm.uid equals cust.id
                    select new OrdermasterCustomerjoin
                    {
                        objordmaster = orm,
        ...
        public ActionResult refunded()
        {
            ...
            list = (from orm in model.ordermasters.Where(m => m.OrderStatus == 6)
                    join cust in model.customers on orm.uid equals cust.id
                    select new OrdermasterCustomerjoin
                    {
                        objordmaster = orm,
        ...
        public ActionResult deleteorder(string id)
        {
            ...
            return RedirectToAction(controllername,"Order");
        }
        ...
        public ActionResult statuschange(long status,string comment,long ordermasterid)
        {
            ...
            return RedirectToAction("orderdetail", "Order", new { id = ordermasterid });
        }
